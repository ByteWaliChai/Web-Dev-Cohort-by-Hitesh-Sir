...
const ret = arr0.forEach(function (value, index) {
  console.log(`Value at Index ${index} is ${value}`);
});

console.log(`Ret is`, ret);

const myRet = arr0.myForEach(function (value, index) {
...
const n = arr0.map((e) => e * 2);
const n2 = arr0.myMap((e) => e * 3);
console.log(n);
console.log(n2);
...
const n3 = arr0.filter((e) => e % 2 === 0);
const n4 = arr0.myFilter((e) => e % 2 === 0);
console.log(n3);
console.log(n4);
